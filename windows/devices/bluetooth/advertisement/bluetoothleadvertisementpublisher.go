...
const GUIDiBluetoothLEAdvertisementPublisher3 string = "1cff3902-61ec-5776-ab86-9b41f94b1e66"
...
type iBluetoothLEAdvertisementPublisher3Vtbl struct {
	...
	SetSecondaryPhy uintptr
}

func (v *iBluetoothLEAdvertisementPublisher3) VTable() *iBluetoothLEAdvertisementPublisher3Vtbl {
	return (*iBluetoothLEAdvertisementPublisher3Vtbl)(unsafe.Pointer(v.RawVTable))
}
