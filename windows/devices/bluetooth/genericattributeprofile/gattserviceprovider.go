...
const GUIDiGattServiceProvider2 string = "9ef531a9-cf12-59a3-a81c-362f4aabaacf"
...
func (v *iGattServiceProvider2) VTable() *iGattServiceProvider2Vtbl {
	return (*iGattServiceProvider2Vtbl)(unsafe.Pointer(v.RawVTable))
}

func (v *iGattServiceProvider2) UpdateAdvertisingParameters(parameters *GattServiceProviderAdvertisingParameters) error {
	hr, _, _ := syscall.SyscallN(
		v.VTable().UpdateAdvertisingParameters,
		uintptr(unsafe.Pointer(v)),          // this
		uintptr(unsafe.Pointer(parameters)), // in GattServiceProviderAdvertisingParameters
	)
