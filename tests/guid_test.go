...
func TestParameterizedInstanceGUID_ReceivedEvent(t *testing.T) {
	...
	got := winrt.ParameterizedInstanceGUID(guidTypedEventHandler, signatureBluetoothLEAdvertisementWatcher, signatureBluetoothLEAdvertisementReceivedEventArgs)
	if got != expected {
...
func TestParameterizedInstanceGUID_StoppedEvent(t *testing.T) {
	...
	got := winrt.ParameterizedInstanceGUID(guidTypedEventHandler, signatureBluetoothLEAdvertisementWatcher, signatureBluetoothLEAdvertisementWatcherStoppedEventArgs)
	if got != expected {
		t.Errorf("got %s, want %s", got, expected)
	}
}
